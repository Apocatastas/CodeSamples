...
#pragma warning restore 0414
    ...
    public void Awake()
    {
        ...
        adholder = GameObject.FindObjectOfType<Admob>();
        m_menuController = GameObject.FindObjectOfType<Assets.SimpleLocalization.MenuController>();
        m_purchaser = GameObject.FindObjectOfType<Purchaser>();
    ...
    public IEnumerator ShowPreAd()
    {
        ...
        {
            m_purchaser.StartCoroutine("SubChecker");
            bool m_noads = false;
            bool m_onlypost = false;
            bool m_both = false;

            m_noads = (Broadcaster.Prefab.name == "Dog") ||
                        (Broadcaster.Prefab.name == "Dino1") ||
                        (Broadcaster.Prefab.name == "Luigi");
            m_onlypost = (Broadcaster.Prefab.name == "Rabbit") ||
                        (Broadcaster.Prefab.name == "Dino2") ||
                        (Broadcaster.Prefab.name == "Guido");
            m_both = (Broadcaster.Prefab.name != "Dog") &&
