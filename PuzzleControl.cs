...
public class PuzzleControl : MonoBehaviour
{
    ...
    IEnumerator ShakeIt()
    {
            ...
            )
        {
            ...
            Dictionary<string, object> demoOptions4 = new Dictionary<string, object>() { { "LEVEL_COMPLETE", Broadcaster.Prefab.name } };
            Amplitude.Instance.logEvent("LEVEL_COMPLETE", demoOptions4);
        }
